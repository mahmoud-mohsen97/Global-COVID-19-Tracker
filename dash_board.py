...
def world_map(df):
    ...
    fig.update_layout(margin=dict(l=100, r=4, t=4, b=4))
...
body_app = dbc.Container([
    ...
    dbc.Row(html.Marquee("USA, India and France are top 3 countries in terms of confirmed cases"),
            style={'color': 'green'}),
    ...
    dbc.Row([dbc.Col(dcc.Graph(id='world-graph', figure=world_map(df_world_f)), style={'height': '450px'}, xs=12, sm=12,
             ...
             [dcc.Dropdown(id='country-dropdown',
                      ...
                      ], style={'height': '450px', 'text-align': 'center'}, xs=12, sm=100, md=6, lg=6, xl=6)
    ...
    dbc.Row(
        [
            dbc.Col(
                ...
                dbc.Button(id='button', children="Support Us", color="primary", className='ml-auto', href='https://www.care.gov.eg/EgyptCare/Index.aspx')
